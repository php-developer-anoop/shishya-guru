  ...
  <div class="content">
    <div class="container-fluid">
      <div class="card card-default">
        ...
        <div class="card-header">
          <?= form_open_multipart(base_url(ADMINPATH.'save-cms')); ?>
          ...
          <div class="form-group row">
            <div class="col-sm-4">
              ...
              <select name="page_name" id="page_name" required class="form-control select2" onchange="getSlug(this.value,'slug')">
                <option value="">Select Page</option>
                <option value="About Us" <?=!empty($page_name) && ($page_name=="About Us")?'selected':''?>>About Us</option>
                <option value="Privacy Policy" <?=!empty($page_name) && ($page_name=="Privacy Policy")?'selected':''?>>Privacy Policy</option>
                <option value="Terms And Conditions" <?=!empty($page_name) && ($page_name=="Terms And Conditions")?'selected':''?>>Terms And Conditons</option>
                <option value="Faqs" <?=!empty($page_name) && ($page_name=="Faqs")?'selected':''?>>Faqs</option>
                <option value="Blogs" <?=!empty($page_name) && ($page_name=="Blogs")?'selected':''?>>Blogs</option>
                <option value="Reviews" <?=!empty($page_name) && ($page_name=="Reviews")?'selected':''?>>Reviews</option>
                <option value="Contact Us" <?=!empty($page_name) && ($page_name=="Contact Us")?'selected':''?>>Contact Us</option>
                <option value="Tutor Register" <?=!empty($page_name) && ($page_name=="Tutor Register")?'selected':''?>>Tutor Register</option>
                <option value="Tutor List" <?=!empty($page_name) && ($page_name=="Tutor List")?'selected':''?>>Tutor List</option>
              </select>
            </div>
            <div class="col-sm-4">
